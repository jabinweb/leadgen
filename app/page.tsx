...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-slate-50 dark:from-slate-950 dark:to-slate-900">
      ...
      {/* Hero Section */}
      <section className="container mx-auto px-4 pt-20 md:pt-32 pb-16 md:pb-24 max-w-6xl">
        <div className="text-center space-y-8">
          ...
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight !leading-[1.1em]">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="rounded-full bg-primary text-white w-16 h-16 flex items-center justify-center text-2xl font-bold mx-auto mb-4">
                1
              </div>
              <h3 className="text-xl font-semibold mb-2">Scrape Leads</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Enrich & Organize</h3>
              <p className="text-slate-600 dark:text-slate-400">
      ...
      {/* Benefits Section */}
      <section id="benefits" className="container mx-auto px-4 py-24 max-w-6xl">
      ...
      <section className="bg-gradient-to-r from-primary to-blue-600 py-20">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button size="lg" variant="outline" className="text-base px-8 h-12 bg-white/10 text-white border-white/20 hover:bg-white/20" asChild>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                <Database className="h-6 w-6 text-primary" />
                <span className="text-lg font-bold">LeadGen Pro</span>
              </div>
